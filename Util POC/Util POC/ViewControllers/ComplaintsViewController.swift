...
class ComplaintsViewController: UIViewController, UINavigationControllerDelegate,CreateIssueServiceDelegate {
   ...
   func checkCameraButtonStatus() {
    ...
    @IBAction func btnSubmitTapped(_ sender: Any) {
        ...
        createIssueService.delegate = self
    ...
    // MARK: -  CreateIssueServiceDelegate methods
    func issueCreatedWithReference(referenceNumber : String){
        ...
        DispatchQueue.main.async {
            ...
            self.showAlert(imageName: "mail-icon", message: "Thank you! your notification has been received. Your reference number is \(referenceNumber)", buttonTitle: "Ok",completion: { [weak self] in
